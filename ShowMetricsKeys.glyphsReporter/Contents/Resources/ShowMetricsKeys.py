...
class ShowMetricsKeys ( NSObject, GlyphsReporterProtocol ):
	...
	def drawTextAtPoint( self, text, textPosition, fontSize=9.0, fontColor=NSColor.brownColor(), textAlignment = 3 ):
		"""
